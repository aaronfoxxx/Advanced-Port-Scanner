...
def prepare_args():
    ...
    """
    parser = ArgumentParser(description="Python Based Fast Port Scanner",usage="%(prog)s 192.168.1.2",epilog="%(prog)s -s 20 -e 40000 -t 500 -V 192.168.1.2")
